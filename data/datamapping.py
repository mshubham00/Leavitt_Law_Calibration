...
if ex_law == '_F':
    ...
    extinction_ratios = {'B': 1.31, 'V': 1.0, 'R': 0.845,'I': 0.608,'J': 0.2969,'H': 0.1805,'K': 0.1231 }   
    Rv = 3.19	
...
nreg = 5*len(dis_flag)
data_dir = './data/input/'
data_out=f'./data/processed/{file_name}{dis_flag[0]}_{R_v}{ex_law}/'
img_out_path='./docs/reports/plots/'
table_out_path='./docs/reports/thesis_version/chapters/content/'
...
def R123(m:str,c1:str,c2:str,R=R):
    ...
    R123 = round(R[m] / (round(R[c1],4) - round(R[c2],4)),4)
    return R123
#####################################################################    
def R_dic(mag=mag):
    R_ = {}
