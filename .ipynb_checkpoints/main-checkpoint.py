### File: ./main.py
k = 0
from lvtlaw.a_utils import select_data_file
from lvtlaw.a_utils import output_directories, load_data, process_step, open_output_dir, flags, data_cols
from lvtlaw.a_utils import colors,data_dir, input_data_file, data_out, dis_list, dis_flag, wes_cols, s, k
...
from lvtlaw.e_star_wise import star_frame, add_res, add_dres
from lvtlaw.f_error_estimation import star_by_star, star_dispersion, result
