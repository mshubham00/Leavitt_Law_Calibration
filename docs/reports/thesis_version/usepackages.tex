...
\usepackage{multicol} 
%\usepackage[acronym]{glossaries} % for abbreviation list
%\makeglossaries
\usepackage[table]{xcolor}   % recommended
\usepackage{colortbl}
\usepackage{multirow}
...
%% Line Spacing %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage[a4paper, left=3.5cm, right=3cm, top=2cm, bottom=2cm]{geometry}
\usepackage{setspace}
\setstretch{1.5}
...
\hypersetup{
   pdfauthor={Shubham Mamgain},
   pdftitle={Master Thesis},
   pdfkeywords={report, Astrophysics, University of Potsdam},
