...
from lvtlaw.utils import A, R, mag, abs_bands, ap_bands, colors, data_dir, data_file, data_out, regression
...
def del_del(residue_file, col): 
    ...
    del_pre_WM_M['name'] = del_res_WM_M['name'] = residue_file['name'] # star by star
